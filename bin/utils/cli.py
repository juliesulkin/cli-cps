...
main_commands = [{'list': 'List all enrollments',
                 ...
                 {'delete': 'Delete an existing enrollment forever!',
                  'optional_arguments': [{'name': 'cn', 'help': 'Common Name of certificate'},
                                         {'name': 'enrollment-id', 'help': 'enrollment-id of the enrollment'},
                                         {'name': 'force', 'help': 'Skip the stdout display and user confirmation', 'action': 'store_true'},
                                         {'name': 'cancel-pending', 'help': 'Cancels all pending changes when updating an enrollment.', 'action': 'store_true'},
                                         {'name': 'deploy-not-after', 'help': 'Do not deploy after this date (UTC) (YYYY-MM-DD)', 'type': 'parser.valid_date'},
                                         {'name': 'deploy-not-before', 'help': 'Do not deploy before this date (UTC) (YYYY-MM-DD)', 'type': 'parser.valid_date'},]},
