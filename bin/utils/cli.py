...
main_commands = [{'list': 'List all enrollments',
                  'optional_arguments': [{'name': 'contract', 'help': 'contract without ctr_ prefix', 'nargs': '+'},
                                         ...
                                         {'name': 'show-expiration', 'help': 'shows expiration date of the enrollment', 'action': 'store_true'}
                                         ]},
                 {'retrieve-enrollment': 'Output enrollment data to json or yaml format',
                  'optional_arguments': [{'name': 'enrollment-id', 'help': 'enrollment-id of the enrollment'},
                                         ...
                                         {'name': 'contract', 'help': 'contract without ctr_ prefix'},
                 ...
                 {'create': 'Create a new enrollment from a yaml or json input file',
                  'optional_arguments': [{'name': 'force', 'help': 'No value'},
                                         ...
                                         {'name': 'allow-duplicate-cn',
                                          'help': 'Allows a new certificate to be created with the same CN as an existing certificate'},
                 ...
                 {'update': 'Update an enrollment from a yaml or json input file',
                  'optional_arguments': [{'name': 'cn', 'help': 'Common Name of Certificate to update'},
                                         ...
                                         {'name': 'force', 'help': 'Skip the stdout display and user confirmation', 'action': 'store_true'},
                                         {'name': 'force-renewal', 'help': 'force certificate renewal for enrollment', 'action': 'store_true'}, ]},
